 ...
 * @author DELL
 */
public class TeacherLeaveForm extends javax.swing.JFrame {
    ...
    private void jButton23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton23ActionPerformed
        ...
        String updateQuery = "UPDATE teachers SET onLeave = TRUE WHERE id = ?";
        ...
        try {
            ...
            if (rowsAffected > 0) {
                JOptionPane.showMessageDialog(null, "Teacher status updated to on leave.");
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeacherLeaveForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
