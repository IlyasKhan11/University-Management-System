...
public class AddStudentForm extends javax.swing.JFrame {
    ...
    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
        ...
        try{
            String query = "INSERT INTO students (name, FatherName, contact, email, address, cnic, dob, dept, onLeave) " +"VALUES ('" + name + "', '" + FName + "', '" + Contact + "', '" + Email + "', '" + address + "', '" +CNIC + "', '23 jan,2005', '" + dept + "', " + "0" + ")";
            Conn c=new Conn();
