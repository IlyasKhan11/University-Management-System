 ...
 * @author DELL
 */
public class UpdateStudenetForm extends javax.swing.JFrame {

    /**
     * Creates new form AddStudentForm
     */
    public UpdateStudenetForm() {
        initComponents();
        LoadStudents();
    }
    ...
    // Get the selected student ID from the combo box
        ...
        // Update query
        String query = "UPDATE students SET name = ?, FatherName = ?, contact = ?, email = ?, address = ?, cnic = ?, dob = ?, dept = ? WHERE id = ?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateStudenetForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
