 ...
 * @author DELL
 */
public class CancelLeaveStudentForm extends javax.swing.JFrame {

    /**
     * Creates new form StudentLeaveForm
     */
    public CancelLeaveStudentForm() {
        initComponents();
        LoadStudens();
    }
    ...
    // Get the selected student ID from the combo box
        ...
        String updateQuery = "UPDATE students SET onLeave = 0 WHERE id = ?";
        ...
        try {
            ...
            if (rowsAffected > 0) {
                JOptionPane.showMessageDialog(null, "Student Leave Status Updated Successfully...");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CancelLeaveStudentForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
